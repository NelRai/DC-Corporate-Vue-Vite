import { useRouter, useRoute, createRouter, createWebHashHistory } from "vue-router";
import { ref, mergeProps, useSSRContext, resolveComponent, withCtx, createVNode, createTextVNode, computed } from "vue";
...
const _sfc_main$i = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_RouterLink, { to: "/#ueber-uns" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$j, { text: "Über uns" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$j, { text: "Über uns" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_RouterLink, { to: "/#ki-beratung" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$j, { text: "KI-Agentur" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$j, { text: "KI-Agentur" })
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><li class="p-0 m-0 h-fit leading-4">`);
      _push(ssrRenderComponent(_component_RouterLink, { to: "/#medienhaus" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$j, { text: "Medienhaus" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$j, { text: "Medienhaus" })
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><li class="p-0 m-0 h-fit leading-4">`);
      _push(ssrRenderComponent(_component_RouterLink, { to: "/#kontakt" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$j, { text: "Kontakt" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$j, { text: "Kontakt" })
            ];
          }
        }),
        _: 1
...
const _sfc_main$f = {
  ...
  setup(__props) {
    ref(0);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<h3${ssrRenderAttrs(mergeProps({ class: "text-3xl lg:text-7xl" }, _attrs))}>${ssrInterpolate(__props.headline)}</h3>`);
    };
  }
};
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</a></div><div class="text-xl flex flex-col lg:flex-row gap-8"><a class="text-white font-light">`);
      _push(ssrRenderComponent(_component_RouterLink, { to: "/impressum" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Impressum`);
          } else {
      ...
      _push(`</a><a class="text-white font-light">`);
      _push(ssrRenderComponent(_component_RouterLink, { to: "/datenschutz" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Datenschutz`);
          } else {
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex flex-col gap-8 pt-32 pb-28 lg:pt-44 lg:pb-28 lg:gap-32"><div class="flex flex-col gap-2 lg:gap-8 text-center lg:text-left w-full max-w-7xl m-auto"><h2 class="font-blinker font-light text-3xl lg:text-[7rem] lg:leading-[7rem]"> Neues Denken.<br>Neue Kompetenzen. HOME </h2><h3 class="text-base lg:text-3xl font-blinker"> Medienhaus &amp; KI-zentrierte Agentur </h3></div><div class="flex flex-wrap justify-center gap-3 mx-10 lg:mx-0">`);
      _push(ssrRenderComponent(_sfc_main$h, {
        text: "KI-Beratung",
        link: "#ki-beratung"
      }, null, _parent));
      ...
      _push(`</div><div id="ueber-uns" class="flex flex-col gap-4 lg:gap-32 -mt-12 pt-16 pb-24 w-full bg-dc-neutral50 border border-neutral-300 border-solid rounded-t-3xl lg:rounded-t-4xl shadow-top3xl lg:pt-32 lg:pb-44 z-10 relative"><div class="px-8 lg:px-0 max-w-7xl m-auto flex flex-col gap-4 lg:gap-16"><h1 class="text-1xl lg:text-7xl"><span class="text-dc-400">Deep Content by heise</span> ist ein digitales Medienhaus mit jahrelanger journalistischer Tech-Expertise. </h1><p class="lg:text-4xl"> Journalist:innen und Kommunikationsprofis arbeiten hier erfolgreich mit generativer KI. Unsere Agentur-Leistungen umfassen etwa Beratung zu KI im Unternehmen, sorgfältig abgestimmte Workshops, individuelle Beratung, etwa rund um Prompting, sowie das Profi-Workflow-Tool DC I/O. </p></div>`);
      _push(ssrRenderComponent(_sfc_main$b, { class: "mt-4" }, null, _parent));
      ...
      _push(ssrRenderComponent(_sfc_main$f, { headline: "KI-Beratung" }, null, _parent));
      ...
      _push(ssrRenderComponent(_sfc_main$f, { headline: "KI-Workshops" }, null, _parent));
      ...
      _push(ssrRenderComponent(_sfc_main$f, { headline: "KI-Software" }, null, _parent));
      ...
      _push(`</div></div></div></div><div id="medienhaus" class="flex flex-col gap-16 lg:gap-32 -mt-12 px-8 pt-8 pb-24 w-full bg-dc-neutral50 border border-neutral-300 border-solid rounded-t-3xl lg:rounded-t-4xl shadow-top3xl lg:pt-32 lg:pb-44 z-50 relative"><article class="flex flex-col gap-8 max-w-7xl m-auto lg:*:w-1/2 lg:flex-row lg:gap-16"><img class="w-full h-full shadow-lg rounded-3xl lg:rounded-images"${ssrRenderAttr("src", _imports_0$2)} alt=""><div class="flex flex-col gap-8"><p><span class="text-dc-400">MIXED</span> ist in Deutschland, Österreich und der Schweiz Marktführer für News und Berichte rund um Zukunfts-Technologien wie VR, AR, KI und mehr. Bei uns trifft sich auch die deutschsprachige Mixed-Reality-Community. Bekannte Nachrichtenseiten wie Spiegel Online, TAZ, BILD, Golem, Manager Magazin, Venturebeat, Techcrunch, Road to VR und viele mehr verlinken auf unsere Artikel. </p>`);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/HomeView.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const _sfc_main$2 = {
  __name: "ImpressumView",
  __ssrInlineRender: true,
  setup(__props) {
    ref(false);
    if (typeof window !== "undefined") {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HeroAnimation = resolveComponent("HeroAnimation");
      const _component_Contact = resolveComponent("Contact");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrapper" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$i, null, null, _parent));
      _push(`<div class="flex flex-col gap-8 pt-32 pb-28 lg:pt-44 lg:pb-28 lg:gap-32"><div class="flex flex-col gap-2 lg:gap-8 text-center lg:text-left w-full max-w-7xl m-auto"><h1 class="font-blinker font-light text-3xl lg:text-[7rem] lg:leading-[7rem]"> Impressum </h1></div>`);
      _push(ssrRenderComponent(_component_HeroAnimation, null, null, _parent));
      _push(`</div><div id="ki-beratung" class="-mt-12 px-8 pt-16 pb-24 w-full bg-dc-neutral50 border border-neutral-300 border-solid rounded-t-3xl lg:rounded-t-4xl shadow-top3xl lg:pt-32 lg:pb-44 relative overflow-hidden z-20"><div class="max-w-7xl m-auto flex flex-col gap-16"><h2 class="text-3xl lg:text-7xl">Verantwortlich für dieses Angebot gemäß § 5 TMG / § 18 MStV:</h2><div class="flex flex-col gap-8 lg:gap-16"><p><strong>Deep Content GmbH</strong><br> Karl-Wiechert-Allee 10<br> 30625 Hannover<br> Deutschland<br><br> Postfach 61 04 07<br> 30604 Hannover<br><br> Telefon: +491717808216<br> E-Mail: hallo@deep-content.io<br> Website: deep-content.io<br><br><strong>Vertretungsberechtigte Geschäftsführer:</strong><br> Benjamin Danneberg<br> Matthias Bastian<br> (Anschrift und Kontakt s.o.)<br><br><strong>Inhaltlich Verantwortliche gem. § 18 Abs. 2 MStV:</strong><br> Benjamin Danneberg<br> Matthias Bastian<br> (Anschrift und Kontakt s.o.)<br><br><strong>Umsatzsteuer-ID:</strong><br> DE326586221<br><br><strong>Handelsregister:</strong><br> HRB 226465<br><br><strong>Registergericht:</strong><br> Amtsgericht Hannover Ein Unternehmen der <a href="https://www.heise-gruppe.de/">Heise Gruppe</a>. </p></div><div><p><strong>Haftung für Inhalte</strong><br> Als Diensteanbieter sind wir gemäß § 7 Abs. 1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis 10 TMG sind wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde Informationen zu überwachen oder nach Umständen zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen. Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen nach den allgemeinen Gesetzen bleiben hiervon unberührt. Eine diesbezügliche Haftung ist jedoch erst ab dem Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung möglich. Bei Bekanntwerden von entsprechenden Rechtsverletzungen werden wir diese Inhalte umgehend entfernen.<br><br><strong>Haftung für Links</strong><br> Diese Website enthält Links zu externen Webseiten Dritter, auf deren Inhalte kein Einfluss genommen werden kann. Deshalb kann für diese fremden Inhalte auch keine Gewähr übernommen werden. Für die Inhalte der verlinkten Seiten ist stets der jeweilige Anbieter oder Betreiber der Seiten verantwortlich. Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf mögliche Rechtsverstöße überprüft. Rechtswidrige Inhalte waren zum Zeitpunkt der Verlinkung nicht erkennbar. Eine permanente inhaltliche Kontrolle der verlinkten Seiten ist jedoch ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht zumutbar. Bei Bekanntwerden von Rechtsverletzungen werden derartige Links umgehend von dieser Website auf die rechtsverletzende Site entfernen.<br><br><strong>Urheberrecht</strong> Die durch die Diensteanbieter, deren Mitarbeiter und beauftragte Dritte erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechtes bedürfen der vorherigen schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. Downloads und Kopien dieser Seite sind nur für den privaten, nicht kommerziellen Gebrauch gestattet. Soweit die Inhalte auf dieser Seite nicht vom Betreiber erstellt wurden, werden die Urheberrechte Dritter beachtet. Insbesondere werden Inhalte Dritter als solche gekennzeichnet. Sollten Sie trotzdem auf eine Urheberrechtsverletzung aufmerksam werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden von Rechtsverletzungen werden derartige Inhalte umgehend entfernen.<br><br><small>Dieses Impressum wurde mit Hilfe des Impressum-Generators von HENSCHE Rechtsanwälte, Kanzlei für Arbeitsrecht erstellt.</small></p></div></div></div>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/ImpressumView.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = {
  __name: "DatenschutzView",
  __ssrInlineRender: true,
  setup(__props) {
    ref(false);
    if (typeof window !== "undefined") {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/DatenschutzView.vue");
...
const routes = [
  ...
  { path: "/impressum", component: _sfc_main$2 },
  { path: "/datenschutz", component: _sfc_main$1 }
];
createRouter({
